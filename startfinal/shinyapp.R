...
# Load Data ----
combined_artists_tracks <- read_csv("spotify_app/data/combined_artists_tracks_2018_2024.csv")
combined_albums_tracks <- read_csv("spotify_app/data/combined_albums_tracks_2018_2024.csv")
new_releases_combined <- read_csv("spotify_app/data/new_releases_combined.csv")
