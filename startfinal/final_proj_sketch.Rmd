...
```{r}
ts_tracks_2024 <- all_tracks_2024 |>
  filter(artist_name == "Taylor Swift")

popular_tracks_2024 <- ggplot(ts_tracks_2024, aes(
  ...
  geom_col() +
  theme_minimal() +
  labs(title = "Top Tracks by Popularity", x = "Track Name", y = "Popularity") +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))

ggplotly(popular_tracks_2024, tooltip = "text")
